...
extern StructMsg	AppMsgStk[APP_QUEUE_MAIN_SIZE + APP_QUEUE_ASSER_SIZE];	// Stack to store msg for Asser and Main Queue
extern StructMsg	AppHighPrioMsg;							// Struct to store an high priority msg (e.g. the stop msg)
extern INT8U		AppMsgCurrentID;						// Next free ID for msg
