...
void OpenOC4 (unsigned int config1, unsigned int config2, unsigned int value1, unsigned int value2)
{
    OC4CON1bits.OCM = 0; /* turn off OC before switching to new mode */
    OC4RS = value1;     /* assign value1 to OCxRS Secondary Register */
    OC4R = value2;      /* assign value2 to OCxR Main Register*/  
    OC4CON1 = config1;    /* assign config to OCxCON Register*/
    OC4CON2 = config2;
}
#else
