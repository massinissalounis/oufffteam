...
INT8U StrategyColorB_GetNextAction(StructCmd *NextAction)
{
	...
	switch(CurrentActionID)
	{
		...
		case 1:		p->CmdType = CmdType_Blocking;	p->ActiveSensorsFlag =	(APP_PARAM_STRATEGYFLAG_NONE);	NextActionID = 2100;	TimeoutID = 2300;	p->Cmd = Mvt_UseDistOnly;	p->Param1 = DEFAULT_SPEED;	p->Param2 = 0;	p->Param3 = 0;	p->Param4 = 180;	break;	// SubStrategyName = Glass2
