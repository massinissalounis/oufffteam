...
INT8U StrategyColorB_GetNextAction(StructCmd *NextAction)
{
	...
	switch(CurrentActionID)
	{
		...
		// LoopID = 0
		case 1:	p->CmdType = CmdType_NonBlocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_NONE;	NextActionID = 1;	TimeoutID = -1; p->Cmd = App_IfGoto_Strategy;		p->Param1 = (APP_PARAM_STRATEGYFLAG_ARMS_IS_INIT);    p->Param2 = 2;    p->Param3 = 3;    		break;	
