...
INT8U StrategyColorB_GetNextAction(StructCmd *NextAction)
{
	...
	switch(CurrentActionID)
	{
		...
		case 104:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_COLLISION_FRONT;	NextActionID = 105;	TimeoutID = 152; p->Cmd = Mvt_UseMixedMode;		p->Param1 = 85;    p->Param2 = 500;    p->Param3 = 1000;    p->Param4 = -55;    		break;	
		...
		case 106:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_COLLISION_FRONT;	NextActionID = 107;	TimeoutID = -1; p->Cmd = Mvt_UseMixedMode;		p->Param1 = 85;    p->Param2 = 740;    p->Param3 = 500;    p->Param4 = 90;    		break;	
		...
		case 109:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_COLLISION_FRONT;	NextActionID = 200;	TimeoutID = -1; p->Cmd = Mvt_UseMixedMode;		p->Param1 = 85;    p->Param2 = 1100;    p->Param3 = 345;    p->Param4 = 90;    		break;	
		...
		case 223:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_COLLISION_FRONT;	NextActionID = 225;	TimeoutID = -1; p->Cmd = Mvt_UseMixedMode;		p->Param1 = DEFAULT_SPEED;    p->Param2 = 640;    p->Param3 = 577;    p->Param4 = 0;    		break;	
		...
		case 305:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_COLLISION_FRONT;	NextActionID = 306;	TimeoutID = -1; p->Cmd = Mvt_UseMixedMode;		p->Param1 = DEFAULT_SPEED;    p->Param2 = 1900;    p->Param3 = 408;    p->Param4 = 90;    		break;	
