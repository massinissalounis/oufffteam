...
INT8U StrategyColorB_GetNextAction(StructCmd *NextAction)
{
	...
	switch(CurrentActionID)
	{
		...
		case 107:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_COLLISION_REAR;	NextActionID = 108;	TimeoutID = -1; p->Cmd = MvtSimple_MoveInMM;		p->Param1 = 70;    p->Param2 = -415;    		break;	
		...
		case 210:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_NONE;	NextActionID = 211;	TimeoutID = -1; p->Cmd = MvtSimple_MoveInMM;		p->Param1 = 70;    p->Param2 = 40;    		break;	
		...
		case 212:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_COLLISION_FRONT;	NextActionID = 215;	TimeoutID = -1; p->Cmd = MvtSimple_MoveInMM;		p->Param1 = DEFAULT_SPEED;    p->Param2 = 300;    		break;	
