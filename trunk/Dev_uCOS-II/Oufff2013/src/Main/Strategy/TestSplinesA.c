...
INT8U StrategyColorA_GetNextAction(StructCmd *NextAction)
{
	...
	switch(CurrentActionID)
	{
		...
		case 5:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_NONE;	NextActionID = 2;	TimeoutID = -1;	p->Cmd = App_Wait;		p->Param1 = 0;    p->Param2 = 0;    p->Param3 = 4;    p->Param4 = 0;    	break;	
		case 2:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_NONE;	NextActionID = 6;	TimeoutID = -1;	p->Cmd = Mvt_UseSpline;		p->Param1 = DEFAULT_SPEED;    p->Param2 = 1950;    p->Param3 = 1667;    p->Param4 = -130;    	break;	
		case 6:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_NONE;	NextActionID = 3;	TimeoutID = -1;	p->Cmd = App_Wait;		p->Param1 = 0;    p->Param2 = 0;    p->Param3 = 4;    p->Param4 = 0;    	break;	
		case 3:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_NONE;	NextActionID = 7;	TimeoutID = -1;	p->Cmd = Mvt_UseSpline;		p->Param1 = DEFAULT_SPEED;    p->Param2 = 1510;    p->Param3 = 1442;    p->Param4 = 180;    	break;	
		case 7:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_NONE;	NextActionID = 4;	TimeoutID = -1;	p->Cmd = App_Wait;		p->Param1 = 0;    p->Param2 = 0;    p->Param3 = 4;    p->Param4 = 0;    	break;	
		case 4:	p->CmdType = CmdType_Blocking;		p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_NONE;	NextActionID = -1;	TimeoutID = -1;	p->Cmd = Mvt_UseSpline;		p->Param1 = DEFAULT_SPEED;    p->Param2 = 1044;    p->Param3 = 1667;    p->Param4 = 120;    	break;	
