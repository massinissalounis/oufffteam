...
// Summary: A macro to enable/disable the user to get the disk properties (size of disk, free space, etc)
// Description: The ALLOW_GET_DISK_PROPERTIES definition can be commented out to allow the user to get the disk properties 
//				(size of disk, free space, etc).
