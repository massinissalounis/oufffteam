...
copy Release\%DLLNAME%.dll ..\..\OufffLib\W32\%DLLNAME%-%DLLVERSION%.dll

echo Export du fichier %DLLNAME%.lib vers %DLLNAME%-%DLLVERSION%.lib :
copy Release\%DLLNAME%.lib ..\..\OufffLib\W32\%DLLNAME%-%DLLVERSION%.lib

echo Export du fichier %DLLNAME%.h vers %DLLNAME%-%DLLVERSION%.h :
copy ..\include\%DLLNAME%.h ..\..\OufffLib\Include\W32\%DLLNAME%-%DLLVERSION%.h

echo Mise à jours des fichiers de bases...
echo Création et copie des fichiers %DLLNAME%.dll, %DLLNAME%.lib et %DLLNAME%.h

copy Release\%DLLNAME%.dll ..\..\OufffLib\W32\%DLLNAME%.dll
copy Release\%DLLNAME%.lib ..\..\OufffLib\W32\%DLLNAME%.lib
copy ..\include\%DLLNAME%.h ..\..\OufffLib\Include\W32\%DLLNAME%.h
