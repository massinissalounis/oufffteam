...
#define IN_PIN_PPS_RP96				96					/* Assign RP96 as Input Pin */
...
#define IN_PIN_PPS_RP119			119					/* Assign RP119 as Input Pin */
#define IN_PIN_PPS_RP120			120					/* Assign RP120 as Input Pin */
#define IN_PIN_PPS_RP121			121					/* Assign RP121 as Input Pin */
...
#define IN_FN_PPS_FLT5				RPINR37bits.FLT5R	/* Assign PWM5 Fault (FLT5) to the corresponding RPn pin*/
#define IN_FN_PPS_FLT6				RPINR38bits.FLT6R	/* Assign PWM6 Fault (FLT6) to the corresponding RPn pin*/
#define IN_FN_PPS_FLT7				RPINR38bits.FLT7R	/* Assign PWM7 Fault (FLT7) to the corresponding RPn pin*/

#define IN_FN_PPS_DTCMP1			RPINR40bits.DTCMP1R	/* Assign PWM Dead Time Compensation 1 (DTCMP1) to the corresponding RPn pin*/
#define IN_FN_PPS_DTCMP2			RPINR40bits.DTCMP2R	/* Assign PWM Dead Time Compensation 2 (DTCMP2) to the corresponding RPn pin*/
#define IN_FN_PPS_DTCMP3			RPINR41bits.DTCMP3R	/* Assign PWM Dead Time Compensation 3 (DTCMP3) to the corresponding RPn pin*/
#define IN_FN_PPS_DTCMP4			RPINR41bits.DTCMP4R	/* Assign PWM Dead Time Compensation 4 (DTCMP4) to the corresponding RPn pin*/
#define IN_FN_PPS_DTCMP5			RPINR42bits.DTCMP5R	/* Assign PWM Dead Time Compensation 5 (DTCMP5) to the corresponding RPn pin*/
#define IN_FN_PPS_DTCMP6			RPINR42bits.DTCMP6R	/* Assign PWM Dead Time Compensation 6 (DTCMP6) to the corresponding RPn pin*/
#define IN_FN_PPS_DTCMP7			RPINR43bits.DTCMP7R	/* Assign PWM Dead Time Compensation 7 (DTCMP7) to the corresponding RPn pin*/

#define IN_FN_PPS_SYNCI1			RPINR45bits.SYNCI1R	/* Assign PWM Sync Input 1 (SYNCI1) to the corresponding RPn pin*/
#define IN_FN_PPS_SYNCI2			RPINR45bits.SYNCI2R	/* Assign PWM Sync Input 2 (SYNCI2) to the corresponding RPn pin*/
#endif
