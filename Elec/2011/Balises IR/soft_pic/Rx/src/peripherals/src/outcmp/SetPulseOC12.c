...
void SetPulseOC12(unsigned int pulse_start, unsigned int pulse_stop)
{   
    ...
    {
        OC12R = pulse_start; /* assign pulse_start to Main Register */
        OC12RS = pulse_stop; /* assign pulse_stop to Secondary Register */
    }
