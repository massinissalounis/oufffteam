...
void ARMS_InitReg(void)
{
	...
	AX12_Write_Reg_Sync(AX12_EVEVATOR_ID, AX12_REG_ALARM_SHUTDOWN, 0x7F);
	...
	AX12_Write_Reg_Sync(AX12_EVEVATOR_ID, AX12_REG_TEMPERATURE_LIMIT, 0x46);
...
{
	AX12_Write_Torque_On_Sync (AAX12_ELEVATOR_ID);
