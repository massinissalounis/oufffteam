...
void UART2Init()
{
	U2BRG = SYSTEMConfig(GetSystemClock(), SYS_CFG_WAIT_STATES | SYS_CFG_PCACHE)/BRG_DIV2/BAUDRATE2-1; //Oscillator PLL Problem
    U2MODE = 0;
...
Overview:
    This routine close the UART2 module.
