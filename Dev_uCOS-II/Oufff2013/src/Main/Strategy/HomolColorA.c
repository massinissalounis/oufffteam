...
INT8U StrategyColorA_GetNextAction(StructCmd *NextAction)
{
	...
	switch(CurrentActionID)
	{
		...
		case 1:		p->CmdType = CmdType_Blocking;	p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_COLLISION_REAR_LONG;		NextActionID = 100;	TimeoutID = 10;		p->Cmd = MvtSimple_MoveInMM;	p->Param1 = DEFAULT_SPEED;		p->Param2 = -500;	p->Param3 = 0;	p->Param4 = 0;		break;	// SubStrategyName = 'SubStrategyName@gID'
		case 10:	p->CmdType = CmdType_Blocking;	p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_NONE;					NextActionID = 11;	TimeoutID = 100;	p->Cmd = Sensors_SetHoopLevel;	p->Param1 = HOOP_LEVEL_DOWN;	p->Param2 = 0;		p->Param3 = 0;	p->Param4 = 0;		break;	// SubStrategyName = 'SubStrategyName@gID'
		case 11:	p->CmdType = CmdType_Blocking;	p->ActiveSensorsFlag =	APP_PARAM_STRATEGYFLAG_NONE;					NextActionID = 100;	TimeoutID = 100;	p->Cmd = MvtSimple_MoveInMM;	p->Param1 = DEFAULT_SPEED;		p->Param2 = 300;	p->Param3 = 0;	p->Param4 = 0;		break;	// SubStrategyName = 'SubStrategyName@gID'

		case 100:	p->CmdType = CmdType_Blocking;	p->ActiveSensorsFlag =	APP_PARAM_APPFLAG_NONE;							NextActionID = 200;	TimeoutID = 200;	p->Cmd = Sensors_SetHoopLevel;	p->Param1 = HOOP_LEVEL_UP;		p->Param2 = 0;		p->Param3 = 0;	p->Param4 = 0;		break;	// SubStrategyName = 'SubStrategyName@gID'
