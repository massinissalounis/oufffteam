...
void HOOPS_InitReg(void)
{
	...
	// CW limits
	AX12_Write_Reg_2_Datas_Sync(AX12_LEFT_HOOP_ID, AX12_REG_CW_LIMIT, 0xE1, 0x00);
	AX12_Write_Reg_2_Datas_Sync(AX12_RIGHT_HOOP_ID, AX12_REG_CW_LIMIT, 0xE1, 0x00);

	// CCW limits
	AX12_Write_Reg_2_Datas_Sync(AX12_LEFT_HOOP_ID, AX12_REG_CCW_LIMIT, 0xB9, 0x02);
	AX12_Write_Reg_2_Datas_Sync(AX12_RIGHT_HOOP_ID, AX12_REG_CCW_LIMIT, 0xB9, 0x02);
}
...
// 	AX12_Write_Position_Sync(AX12_RIGHT_HOOP_ID, 0x02, 0x8F);
	...
	AX12_Dual_Write_Position_Sync (AX12_LEFT_HOOP_ID, AX12_RIGHT_HOOP_ID, 0x02, 0x8F, 0x02, 0x8F);
{
}
...
// 	AX12_Write_Position_Sync(AX12_RIGHT_HOOP_ID, 0x01, 0x86);
	...
	AX12_Dual_Write_Torque_On_Sync (AX12_LEFT_HOOP_ID, AX12_RIGHT_HOOP_ID);
	AX12_Dual_Write_Position_Sync (AX12_LEFT_HOOP_ID, AX12_RIGHT_HOOP_ID, 0x01, 0x86, 0x01, 0x86);
}
